...
$pdf->SetXY(25,112);
$pdf->SetFontSize(12);
$pdf->Write(0,'dan berdasarkan pengakuan _____________ ____________ bahwa almarhum telah');
//$pdf->Write(0,$ttl);
$pdf->SetXY(25,118);
$pdf->SetFontSize(12);
...
$pdf->SetXY(40,160);
$pdf->SetFontSize(12);
$pdf->Write(0,'Surat Keterangan ini dipergunakan untuk ___________________');
$pdf->SetXY(40,166);
$pdf->SetFontSize(12);
