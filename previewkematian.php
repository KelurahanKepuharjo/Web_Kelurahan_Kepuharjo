...
$query = mysqli_query($conn,"SELECT no_surat,nama,tempat_lahir,tanggal_lahir,jenis_kelamin,kebangsaan,agama,status,pekerjaan,nik,alamat,tgl_pengajuan, no_hp from surat_tidak_mampu join akun on surat_tidak_mampu.id_akun = akun.id_akun WHERE id_surat =  'IDS0002'");
