...
$pdf->Cell(0,80,'SURAT KETERANGAN USAHA',0,0,'C');
$pdf->SetFont('Times','');
$pdf->SetXY(70,62);
$pdf->SetFontSize(12);
$pdf->Write(10,'Nomor : ');
...
$pdf->SetXY(40,150);
$pdf->SetFontSize(12);
$pdf->Write(0,'Menerangkan bahwa nama tersebut diatas benar mempunyai Usaha ___________');
$pdf->SetXY(25,156);
$pdf->SetFontSize(12);
$pdf->Write(0,'________________________________________________. Surat keterangan ini hanya');
$pdf->SetXY(25,162);
$pdf->SetFontSize(12);
