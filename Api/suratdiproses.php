...
class belum_menikah extends koneksii
{
    public function suratdiproses()
    {
        ...
        if($_SESSION['hak_akses']=='2'){
           ...
           $rt= $_SESSION['rt'];
           $rw = $_SESSION['rw'];
               $sql = "SELECT `id_surat`, `no_surat`, `nama`, `tempat_lahir`, `tanggal_lahir`, `jenis_kelamin`, `kebangsaan`, `agama`, `status`, `pekerjaan`, `nik`, `alamat`, `status_surat`, `tgl_pengajuan`, surat_ket_belum_menikah.RT, surat_ket_belum_menikah.RW, `surat_digunakan`, tgl_surat_dibuat, surat_ket_belum_menikah.image, akun.id_akun, akun.no_hp FROM `surat_ket_belum_menikah` JOIN akun ON akun.id_akun = surat_ket_belum_menikah.id_akun WHERE status_surat='$row' AND surat_ket_belum_menikah.RW = '$rw'";
               $result = $this->koneksi->prepare($sql);
               $result->execute();
               return $result;
        }elseif($_SESSION['hak_akses']=='1'){
...
class kematian extends koneksii
{
    public function suratdiproses()
    {
      ...
      if($_SESSION['hak_akses']=='2'){
         ...
         $rt= $_SESSION['rt'];
         $rw = $_SESSION['rw'];
               $sql = "SELECT `id_surat`, `no_surat`, `nama_almarhum`, `saksi_kematian`, `hubungan`, `hari`, `tanggal`, `alamat`, `nik_almarhum`, `penyebab_kematian`, `surat_digunakan`, `tanggal_dibuat`, `status_surat`, `tgl_pengajuan`, surat_kematian.RT, surat_kematian.RW, surat_kematian.image, akun.id_akun, akun.no_hp  FROM `surat_kematian` JOIN akun ON akun.id_akun = surat_kematian.id_akun WHERE status_surat='$row' AND surat_kematian.RW = '$rw'";
               $result = $this->koneksi->prepare($sql);
               $result->execute();
               return $result;
      }elseif($_SESSION['hak_akses']=='1'){
...
class berkelakuanbaik extends koneksii
{
    ...
    {   
        ...
        if($_SESSION['hak_akses']=='2'){
           ...
           $rt= $_SESSION['rt'];
    $rw = $_SESSION['rw'];
        $sql = "SELECT `id_surat`, `no_surat`, `nama`, `tempat_lahir`, `tanggal_lahir`, `jenis_kelamin`, `kebangsaan`, `agama`, `status`, `pekerjaan`, `nik`, `alamat`, `status_surat`, `tgl_pengajuan`, surat_berkelakuan_baik.RT, surat_berkelakuan_baik.RW, `surat_digunakan`, `tgl_surat_dibuat`, `file_pdf`, surat_berkelakuan_baik.image, akun.id_akun, akun.no_hp FROM `surat_berkelakuan_baik` JOIN akun ON surat_berkelakuan_baik.id_akun=akun.id_akun WHERE status_surat='$row' AND surat_berkelakuan_baik.RW = '$rw'";
        $result = $this->koneksi->prepare($sql);
        $result->execute();
        return $result;
        }elseif($_SESSION['hak_akses']=='1'){
           ...
           $rt= $_SESSION['rt'];
    $rw = $_SESSION['rw'];
        $sql = "SELECT `id_surat`, `no_surat`, `nama`, `tempat_lahir`, `tanggal_lahir`, `jenis_kelamin`, `kebangsaan`, `agama`, `status`, `pekerjaan`, `nik`, `alamat`, `status_surat`, `tgl_pengajuan`, surat_berkelakuan_baik.RT, surat_berkelakuan_baik.RW, `surat_digunakan`, `tgl_surat_dibuat`, `file_pdf`, surat_berkelakuan_baik.image, akun.id_akun, akun.no_hp FROM `surat_berkelakuan_baik` JOIN akun ON surat_berkelakuan_baik.id_akun=akun.id_akun WHERE status_surat='$row'";
        $result = $this->koneksi->prepare($sql);
        $result->execute();
        return $result;
        }else{
